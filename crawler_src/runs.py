...
from crawler_src.cookie_consent_handler import CookieConsentHandler, accept_cookies, reject_cookies, detect_consent_banner, detect_accept_button, detect_subscribe_button, detect_essentials_only_button, accept_essentials_only
from crawler_src.utils import get_keywords, get_setting_keywords, get_save_setting_keywords, get_essentials_only_keywords, scroll_to_bottom
...
def run_reject(domain: str):
    ...
    logger.info(f"Loaded {len(reject_keywords)} reject keywords, {len(accept_keywords)} accept keywords, {len(setting_keywords)} setting keywords, {len(save_keywords)} save keywords, and {len(essentials_only_keywords)} essentials only keywords from words.json")
